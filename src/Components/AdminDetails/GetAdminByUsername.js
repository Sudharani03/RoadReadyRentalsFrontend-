        ...
        <div className='all-div'>
            ...
            <section className="services" id="services" style={{ textAlign: 'center' }}>
                <div className="services-container" style={{ display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
                    <input type="text" value={adminIdInput} onChange={handleInputChange} placeholder="Enter Username" style={{ margin: '10px', padding: '5px' }} />
                    <button onClick={fetchAdminByUsername} className='btn btn-primary' style={{ width: '150px', margin: '10px', padding: '8px', cursor: 'pointer', backgroundColor: '#007bff', color: '#fff', border: '1px solid #007bff', borderRadius: '4px', transition: 'background-color 0.3s ease' }} onMouseOver={(e) => e.target.style.backgroundColor = '#0056b3'} onMouseOut={(e) => e.target.style.backgroundColor = '#007bff'}>Submit</button>
